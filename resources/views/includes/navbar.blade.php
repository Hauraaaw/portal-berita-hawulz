        ...
        <div class="flex items-center justify-between w-full lg:w-auto">
          ...
          <a href="index.html">
            <div class="flex items-center gap-2">
              <img src="{{ 'assets/img/Logo.png' }}" alt="Logo" class="w-8 lg:w-10">
...
>
    <ul class="flex flex-col lg:flex-row items-start lg:items-center gap-4 font-medium text-base w-full lg:w-auto">
        <li>
            <a href="index.html" class="text-primary hover:text-gray-600">
                Beranda
            </a>
        </li>
        ...
        @foreach (\App\Models\NewsCategory::all() as $category)
            <li>
                <a href="gayahidup.html" class="hover:text-primary">
                    {{ $category->title }}
                </a>
            </li>
        @endforeach
